...
public class LocatorCRM {
    ...
    public static String inputFirstNameContact = "//input[@id='firstname']";
    public static String inputLastNameContact = "//input[@id='lastname']";
    public static String inputPositionContact = "//input[@id='title']";
    ...
    public static String checkboxDoNotSendEmail = "//label[@for='donotsendwelcomeemail']";
    public static String buttonSaveContact = "//form[@id='contact-form']//button[normalize-space()='Save']";
    public static String alertSaveContactSuccess = "//div[@id='loom-companion-mv3']";
    public static String firstContactOnTable = "//td[@class='sorting_1']/a";
